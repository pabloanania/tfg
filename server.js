                ...
                if (condition.type != null) {
                    switch (condition.type) {
                        ...
                        case "twosidefilter&&if":
                            code += "filtered" + condition.entity[0] + " = filtered" + condition.entity[0] + ".Where(" + condition.parameters[0] + ");\nfiltered" + condition.entity[1] + " = filtered" + condition.entity[1] + ".Where(" + condition.parameters[1] + ");\nif( filtered" + condition.entity[0] + ".Count() > 0 && filtered" + condition.entity[1] + ".Count() > 0 ){";
                            curlyCloseCount++;
                            break;
                        case "invoke":
