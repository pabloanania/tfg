    ...
    for (var i = 0; i < inputEvents.length; i++) {
        ...
        for (var j = 0; j < event.actions.length; j++) {
            ...
            switch (action.name) {
                ...
                case "set_text":
                    auxAct["parameters"] = action.entity + ".text = " + action.parameters.text + ";";
                    auxAct["entity"] = action.entity;
                    break;
                ...
                case "create_entity":
                    auxAct["parameters"] = "Instantiate(" + action.parameters.entity + ", new Vector3(" + action.parameters.x_position + ", " + action.parameters.y_position + ", " + action.parameters.z_position + "), Quaternion.identity);";
                    auxAct["entity"] = action.entity;
                    break;
    ...
    convertNodeToCode: function (codeNode) {
        ...
        for (var i = 0; i < codeNode.length; i++) {
            ...
            if (invokeCallbackCode) {
                this.invokeCallbacks += "void InvokeCallback" + invokeCallbackCount + "(){ " + aux + " }\n";
