    ...
    for (var i = 0; i < inputEvents.length; i++) {
        ...
        for (var j = 0; j < event.actions.length; j++) {
            ...
            switch (action.name) {
                ...
                case "create_entity":
                    auxAct["parameters"] = "Instantiate(all" + action.parameters.entity + ".First(), new Vector3(" + action.parameters.x_position + ", " + action.parameters.y_position + ", " + action.parameters.z_position + "), Quaternion.identity);";
                    auxAct["entity"] = action.entity;
                    break;
